    ...
    /*return (
      <List subheader={<ListSubheader>Current Plan</ListSubheader>} className={classes.root}>
        <ListItem divider={true}>
          ...
          <ListItemText id='switch-list-label-wifi' primary='Some Major Title: ' />
          <ListItemSecondaryAction>
            <IconButton edge='end' aria-label='clear' onClick={handleToggle}>
                <ClearIcon/>
            </IconButton>
          </ListItemSecondaryAction>
        </ListItem>
        <ListItem divider={true}>
            ...
            <ListItemText id='switch-list-label-wifi' primary='ISpec: Human Pathology' />
            <ListItemSecondaryAction>

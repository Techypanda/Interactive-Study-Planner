...
#Executing
sam local invoke --env-vars unittests/debug.json DeleteTraitFunction -e unittests/payloads/trait/DeleteTraitEvent.json > unittests/responses/trait/DeleteNonExistResponse.json
#Comparing expected response to actual response
...
#Executing
sam local invoke --env-vars unittests/debug.json DeleteCareerFunction -e unittests/payloads/career/DeleteCareerEvent.json > unittests/responses/career/DeleteNonExistResponse.json
#Comparing expected response to actual response
